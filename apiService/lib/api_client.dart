  ...
  dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'AuthAuthByFirebase':
          return AuthAuthByFirebase.fromJson(value);
        case 'AuthAuthByFirebaseRResponse':
          return AuthAuthByFirebaseRResponse.fromJson(value);
        case 'PayloadUserPremium':
          return PayloadUserPremium.fromJson(value);
        case 'PayloadUserUser':
          return PayloadUserUser.fromJson(value);
        case 'UserCreatePremium':
          return UserCreatePremium.fromJson(value);
        case 'UserCreatePremiumRResponse':
          return UserCreatePremiumRResponse.fromJson(value);
        case 'UserCreateUser':
          return UserCreateUser.fromJson(value);
        case 'UserCreateUserRResponse':
          return UserCreateUserRResponse.fromJson(value);
        case 'UserGetOne':
          return UserGetOne.fromJson(value);
        case 'UserGetOneRResponse':
          return UserGetOneRResponse.fromJson(value);
        default:
          Match match;
